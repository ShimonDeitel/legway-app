            ...
            ZStack {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 16) {
                        TextField("Flight", text: $primaryText)
                            .textFieldStyle(.roundedBorder)
                            .accessibilityIdentifier("field_primary")
                        TextField("Layover Notes", text: $secondaryText, axis: .vertical)
                            .textFieldStyle(.roundedBorder)
                            .accessibilityIdentifier("field_secondary")
                        
                    TextField("Layover (min)", text: $numericText)
                        .keyboardType(.decimalPad)
                        .textFieldStyle(.roundedBorder)
                        .accessibilityIdentifier("field_numeric")
                        
                    TextField("Airline", text: $tag)
                        .textFieldStyle(.roundedBorder)
